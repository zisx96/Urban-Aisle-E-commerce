...
const Login = () => {
  ...
  return (
    <div className='px-10 w-full lg:w-[70%]'>
      <p className='text-3xl font-bold pb-5 pt-5'>Sign In</p>
      <GoogleSignIn />
      ...
      <div className='pt-4'>
        <form onSubmit={onSubmit} >
          ...
          <button className='border rounded-lg w-full h-[48px] bg-black text-white mt-4 hover:opacity-80'>Sign In</button>
        </form>
      </div>
      {error && <p className=' pt-2 text-right text-lg text-red-400'>{error}</p>}
